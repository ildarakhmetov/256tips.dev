---
layout: tip.vto
title: 'Learn in Your "+1" Zone (not "+100", not "+0")'
tip_number: 240
date: 2026-06-07 12:00:00
description: "Pick what to learn next by aiming for your +1 zone — new enough to grow, close enough to your current skills that you don't shut down in panic mode."
tags:
- tip
- learning
- mindset
...
* Another option could be learning some **tooling** for Python, like `uv` or `ruff`.
